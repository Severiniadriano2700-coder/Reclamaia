...
export const plans: PlanDefinition[] = [
  ...
  },
  {
    id: "PRO",
    name: "Pro",
    description: "Trato preferente para quien reclama con frecuencia.",
    price: 9,
    interval: "mes",
    claimsPerMonth: 5,
    ...
    highlighted: true,
    features: [
      "5 reclamaciones al mes",
      "Ahorra hasta 8,50€/mes frente al pago por reclamación",
      "Envío directo por email",
      "Plantillas guardadas",
      "Historial ilimitado",
      "100 mensajes al mes con el asistente",
      "Atención y revisión prioritaria",
    ],
  },
  {
    id: "BUSINESS",
